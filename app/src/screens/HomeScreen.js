...
const story = StyleSheet.create({
  ...
  avatar:     { width: 54, height: 54, borderRadius: 27, alignItems: 'center', justifyContent: 'center', borderWidth: 2.5, borderColor: '#0f0f1a' },
...
const mc = StyleSheet.create({
  card:       { width: CARD_W, height: 230, borderRadius: 22, overflow: 'hidden', marginRight: 12, backgroundColor: '#1a1a2e' },
...
function IcebreakerCard({ question, responseCount, onAnswer }) {
  ...
  return (
    <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
      <LinearGradient colors={['#1a1a42', '#12122e']} style={ib.card}>
        ...
        <TouchableOpacity style={ib.btn} onPress={onAnswer} activeOpacity={0.85}>
          <LinearGradient colors={['#5865f2', '#4752c4']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={ib.btnGrad}>
...
const ib = StyleSheet.create({
  card:       { borderRadius: 24, padding: 22, gap: 16, borderWidth: 1, borderColor: '#5865f240' },
  topRow:     { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  labelBadge: { backgroundColor: '#5865f222', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 5, borderWidth: 1, borderColor: '#5865f240' },
  labelText:  { color: '#5865f2', fontSize: 12, fontWeight: '700' },
...
const expS = StyleSheet.create({
  card:        { backgroundColor: '#13132a', borderRadius: 20, padding: 16, gap: 12, borderWidth: 1, borderColor: '#1e1e38' },
  ...
  interestBtn: { backgroundColor: '#5865f218', borderRadius: 12, paddingVertical: 11, alignItems: 'center', borderWidth: 1, borderColor: '#5865f240' },
  interestText:{ color: '#5865f2', fontSize: 14, fontWeight: '700' },
});
...
const sh = StyleSheet.create({
  ...
  actionBtn: { backgroundColor: '#5865f218', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 6, borderWidth: 1, borderColor: '#5865f240' },
  actionText:{ color: '#5865f2', fontSize: 12, fontWeight: '700' },
});
      ...
      <Animated.View style={[styles.stickyBar, { opacity: headerOpacity }]}>
        <SafeAreaView>
          <View style={styles.stickyInner}>
            <Text style={styles.stickyLogo}>Bond</Text>
      ...
      >
            ...
            <SafeAreaView>
              <View style={styles.heroInner}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.greetingSub}>{user?.country || 'Earth 🌍'}</Text>
                </View>
        ...
        <Animated.View style={[styles.section, sectionStyle(2)]}>
          ...
          {loadingMatches ? (
            ...
            <LinearGradient colors={['#1a1a3a', '#12122e']} style={styles.emptyCard}>
        ...
        <Animated.View style={[styles.section, sectionStyle(5)]}>
          ...
          {loadingExps ? (
            <ActivityIndicator color="#5865f2" style={{ marginVertical: 24 }} />
...
const styles = StyleSheet.create({
  ...
  stickyBar:       { position: 'absolute', top: 0, left: 0, right: 0, zIndex: 20, backgroundColor: '#0a0a18f0', borderBottomWidth: 1, borderBottomColor: '#1a1a2e' },
  ...
  notifBtn:        { width: 40, height: 40, alignItems: 'center', justifyContent: 'center', backgroundColor: '#1a1a2e', borderRadius: 14, borderWidth: 1, borderColor: '#2a2a4a' },
  ...
  moreCard:        { width: 80, height: 230, backgroundColor: '#13132a', borderRadius: 22, alignItems: 'center', justifyContent: 'center', gap: 6, borderWidth: 1, borderColor: '#1e1e38', borderStyle: 'dashed' },
  moreNum:         { color: '#5865f2', fontSize: 28, fontWeight: '300' },
  moreLabel:       { color: '#555', fontSize: 12, textAlign: 'center', lineHeight: 18 },

  emptyCard:       { borderRadius: 24, padding: 28, alignItems: 'center', gap: 10, borderWidth: 1, borderColor: '#5865f220' },
  emptyTitle:      { color: '#fff', fontSize: 18, fontWeight: '700' },
  emptySub:        { color: '#555', fontSize: 13, textAlign: 'center', lineHeight: 20 },
  emptyBtn:        { backgroundColor: '#5865f2', borderRadius: 14, paddingHorizontal: 24, paddingVertical: 12, marginTop: 6 },
  emptyBtnText:    { color: '#fff', fontSize: 14, fontWeight: '700' },
  emptyExps:       { backgroundColor: '#13132a', borderRadius: 20, padding: 28, alignItems: 'center', gap: 8, borderWidth: 1, borderColor: '#1e1e38', borderStyle: 'dashed' },
  emptyLink:       { color: '#5865f2', fontSize: 14, fontWeight: '600', marginTop: 6 },
