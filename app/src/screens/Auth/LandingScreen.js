...
export default function LandingScreen({ onGetStarted, onSignIn }) {
  ...
  return (
    <LinearGradient colors={['#07071a', '#0a0a18', '#0d0d22']} style={styles.container}>
...
const styles = StyleSheet.create({
  ...
  pulseRing:    { position: 'absolute', borderRadius: 999, backgroundColor: '#5865f2' },
  pulseRing1:   { width: LOGO_SIZE * 1.6, height: LOGO_SIZE * 1.6 },
  pulseRing2:   { width: LOGO_SIZE * 2.0, height: LOGO_SIZE * 2.0 },

  logoOuter:    { width: LOGO_SIZE, height: LOGO_SIZE, borderRadius: LOGO_SIZE / 2, padding: 3, backgroundColor: '#5865f230' },
  ...
  pill:         { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#12122a', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: '#1e1e38' },
  pillIcon:     { fontSize: 13 },
  pillLabel:    { color: '#888', fontSize: 12, fontWeight: '600' },

  stepsCard:    { width: '100%', backgroundColor: '#12122a', borderRadius: 20, padding: 20, gap: 0, borderWidth: 1, borderColor: '#1e1e38' },
  stepRow:      { flexDirection: 'row', alignItems: 'center', gap: 14, paddingVertical: 2 },
  stepIconWrap: { width: 36, height: 36, borderRadius: 12, backgroundColor: '#5865f215', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#5865f230' },
  stepIcon:     { fontSize: 16 },
  stepText:     { color: '#c0c0e0', fontSize: 14, fontWeight: '600', flex: 1 },
  stepConnector:{ position: 'absolute', left: 17, top: 38, width: 2, height: 16, backgroundColor: '#1e1e38' },
  ...
  secondaryBtnText: { color: '#5865f2', fontSize: 16, fontWeight: '600' },

  footer:   { color: '#2a2a4a', fontSize: 12, textAlign: 'center' },
});
